...
CL_CONTEXT_EMULATOR_DEVICE_INTELFPGA=1 ./target/release/rust-opencl-fpga -orust-opencl-fpga-emu.png ../../data/original_image.png

echo "#-------------------FPGA execution"
echo "Execute the code the hardware image"
LD_PRELOAD=${JEMALLOC_PRELOAD} FPGA_AOCX_PATH=${HARD_IMAGE} ./target/release/rust-opencl-fpga -orust-opencl-fpga-hard.png ../../data/original_image.png
